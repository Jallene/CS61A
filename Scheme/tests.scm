...
(cdr '(That is what she said))
;expect (is what she said)
...
(car (quote (Mitch (is (cool (!))))))
;expect mitch

(begin (print 'mitch) (print 'is) (print 'cool) (+ 5 4))
;expect mitch ; is ; cool ; 9
...
(define zedd (mu (x) (* x y 2)))
;expect zedd
(define g (lambda (x y z) (zedd (+ x x))))
;expect g
(g 10 9 2)
;expect 360
